...
public class HomeObject_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.eteks.sweethome3d.model.HomeObject"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(HomeObject_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.eteks.sweethome3d.model.HomeDoorOrWindow$Property",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.beans.PropertyChangeListener", false, HomeObject_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(HomeObject_ESTest_scaffolding.class.getClassLoader()); 
